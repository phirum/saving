        ...
        if (_.isUndefined(getLast)) {
            ...
            if (s.startsWith(productDoc._id, '2')) {
                ...
                if (productDoc._id == '201' || productDoc._id == '202') {
                    alertify.alert(
                        'Confirm',
                        renderTemplate(Template.saving_withdrawalConfirmForActiveInterest, confirmData),
                        function () {
                    ...
                    alertify.alert(
                        'Confirm',
                        renderTemplate(Template.saving_withdrawalConfirmForAchievment, confirmData)
                    );
                }
                ...
                alertify.alert(
                    'Confirm',
                    renderTemplate(Template.saving_withdrawalConfirm, confirmData), function () {
                        t.find('[name="principalRe"]').value = principalResult;
                        t.find('[name="interestRe"]').value = interestResult;
